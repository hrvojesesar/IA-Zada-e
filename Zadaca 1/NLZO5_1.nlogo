...
Ukoliko usisivač, prilikom kretanja, naiđe na prljavštinu očisti je (tj. ćelija se oboji crno) i ispisuje se poruka o pronađenoj prljavštini. Nakon što usisivač počisti cijelu prostoriju, simulacija se zaustavlja.  

## VRSTA OKRUŽENJA

Po kriteriju **determinističnosti** ovo je **determinističko** okruženje jer je stanje okruženja u potpunosti određeno trenutnim stanjem i djelovanjem agenta.

U ovom primjeru jedina promjena u okruženju nastaje djelovanjem agenta (čišćenje ćelije prostorije).
